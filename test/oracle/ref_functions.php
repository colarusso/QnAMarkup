...
# Set Error Reporting
error_reporting(E_ALL & ~E_WARNING & ~E_NOTICE & ~E_DEPRECATED); ini_set("display_errors",1);
...
#	global $compressed_q;
	...
	#position
	global $Qpos;
	global $questions; global $answers; global $qvarname; global $title; global $author; global $description; global $before; global $after; $title=null;$author=null;$description=null;$before=null;$after=null;
	...
	# Set counters et al
	$numberline = array(); $questions=null; $answers=null; $qvarname=array(); 
#	$ordercheck = "";
	$lastnest = -1;
	$lastvalue = "";
	$Qnode = 0;
